...
begin
  ...
  begin
    ...
    Application.MessageBox('Cliente não Atualizado', 'Atenção',
      MB_ICONEXCLAMATION);
...
begin
  ...
  begin
    ...
    Application.MessageBox('Cliente não apagado', 'Atenção',
      MB_ICONEXCLAMATION);
...
begin
  ...
  begin
    Application.MessageBox('Campo email Vazio!', 'Atenção', MB_OK);
    edtEmail.SetFocus;
  end
  else
  begin
